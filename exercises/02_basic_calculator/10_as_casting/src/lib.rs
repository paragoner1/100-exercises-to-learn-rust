...
mod tests {
    ...
    #[test]
    fn u16_to_u32() {
        let v: u32 = 47; // Since u32 is larger, the value fits perfectly.
    ...
    fn u8_to_i8() {
        ...
        let y: i8 = -1; // // 255 (u8) is 0..255 range, but i8 is -128..127. Converting 255 to i8 wraps around.
        // 255 - 256 = -1, so 255u8 as i8 becomes -1.
    ...
    #[test]
    fn bool_to_u8() {
        let v: u8 = 1; // Convert true (bool) to u8 using `as`. In Rust, true as u8 is 1, false as u8 is 0.
